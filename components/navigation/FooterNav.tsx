  ...
  return (
    <footer aria-label="Footer" className="mt-auto text-white" style={{ background: "var(--gradient-band)" }}>
      ...
      <div className="px-6 py-14">
        <div className="mx-auto grid max-w-[clamp(20rem,94vw,84rem)] gap-10 sm:grid-cols-2 lg:grid-cols-[1.1fr_repeat(4,1fr)]">
          <div>
        ...
        <div className="mx-auto mt-10 max-w-[clamp(20rem,94vw,84rem)] rounded-3xl border border-[var(--color-gold)]/25 bg-white/5 p-6 sm:flex sm:items-center sm:justify-between sm:gap-6 sm:p-8">
          <div>
        ...
        <div className="mx-auto mt-10 flex max-w-[clamp(20rem,94vw,84rem)] flex-wrap items-center gap-x-6 gap-y-2 border-t border-white/15 pt-6">
          <h4 className="flex items-center gap-2 text-xs font-bold tracking-wider text-white/55 uppercase">
        ...
        <div className="mx-auto mt-6 flex max-w-[clamp(20rem,94vw,84rem)] flex-wrap items-center justify-between gap-4 border-t border-white/15 pt-6 text-sm text-white/70">
          <div>
            <p>{tFooter("tagline")}</p>
