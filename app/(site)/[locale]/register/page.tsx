...
export default async function RegisterPage({
  ...
  return (
    <div>
      ...
      {ladder.length > 0 && (
        <section className="mx-auto max-w-7xl px-6 pt-16 2xl:max-w-[100rem]">
      ...
      <section id="registration-guidelines" className="mx-auto max-w-5xl px-6 pt-16 pb-16 2xl:max-w-7xl">
      ...
      <section className="mx-auto max-w-7xl px-6 pb-16 2xl:max-w-[100rem]">
