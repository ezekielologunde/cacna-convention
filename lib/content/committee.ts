// Transcribed from the 2026 Convention & Conference Committee Members list
// (2026-07-17). Supersedes the earlier 3-person subset that carried phone
// numbers and organization names -- the fuller list has neither for any of
// its 30 members, and the first three entries here are the same people as
// the old list under fuller/more formal name variants (e.g. "Pastor Yomi
