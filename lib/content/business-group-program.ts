...
export const businessGroupExecutives: string[] = [
  "Pastor Bolaji Oladunni — Chairman",
  "Engineer Ajibola Osinubi — Vice Chairman",
  "Evangelist Gbemisola Oluwayimika — Secretary",
  "Evangelist Olubunmi Otun — Assistant Secretary",
  "Elder Emmanuel Odetoye — Financial Secretary",
  "Evangelist Eunice Alabi Oni — Treasurer",
  "Evangelist Janet Olajide — P.R.O",
  "Evangelist Adebisi Abikoye — Assistant P.R.O",
  "Evangelist Wunmi Atomolagun — Assistant P.R.O",
];
...
export const kingdomEconomicsMessage = {
  ...
  body: [
    ...
    "The Apostle Paul, in his letter to the Church in Colosse, says that even ordinary labor becomes worship when done unto God: \"Whatever you do, do it heartily, as to the Lord and not to men\" (Colossians 3:23). Every servant was entrusted with resources and accountability was expected — this means that a manager who behaves like an owner becomes careless, selfish and abusive, but a manager who knows he will give account becomes careful, responsible and faithful. Henceforth, we should stop behaving like Nabal in 1 Samuel 25:10-11, no more is my money, my business, my skill but we must start doing it God's way and start saying God has entrusted this to me. \"The earth is the Lord's and all its fullness\" (Psalm 24:1).",
    "A Few Examples in the Real World: dishonesty in any ramification is an abomination to the Lord. In academics — cheating on exams, then testifying about passing with honors. In business — bribing officials or inflating numbers to close a deal, claiming it a \"divine blessing.\" In immigration — fake weddings and fabricated asylum stories, then thanking God for a green card while misquoting Ephesians 3:20. In welfare — concealing income to qualify for government assistance like Medicaid, food stamps, or housing meant for the poor, only to say \"God did it.\" In ministry — lobbying, playing politics, or paying for a path to a higher title, then claiming God did it again. In taxes — lying about income on a loan application or cheating on taxes to get a larger refund, then giving glory to God for deception. Many of these situations involve a door forced open by dishonest methods. We give God for cheating on shortcuts and compromise, not the blessing of God.",
    "Pastor Bolaji Oladunni, Chairman of the Business Group Fellowship, shared this testimony: \"Many years ago, I found myself in a corner with an open door, but it came with a catch. To close the deal, I had to slightly exaggerate the numbers and quickly paint a picture that wasn't entirely true. I told myself, 'The end justifies the means. God understands. I will pay my tithe.' So, I agreed to the deal and I took the shortcut. On the outside, it looked like a massive win. But on the inside, it wasn't God's provision; it was my own compromise. Within the community of faith, we naturally expect high standards of integrity. Therefore, it is deeply discouraging to look around and see compromise everywhere instead. As Christians today, our greatest battle is resisting the temptation to cut corners just to get ahead — especially when the world's shortcuts offer us faster results than waiting on God.\"",
    "Poverty will come to the man who hasteth to be rich in an evil way (Proverbs 28:19-22). In all labor there is profit, but talking of financial success leads to penury (Proverbs 14:23). Wealth acquired through labor increases, but vanity diminishes wealth (Proverbs 13:11, NKJV).",
    "God is moving in the marketplace! The world is changing, and we will either be left behind or learn to do business differently — His Way, the Kingdom Way. By using biblical techniques, the power of prayer, and the leading of the Holy Spirit, it is possible to thrive in any environment.",
    "Taking the client's requests very seriously because we believe in the power of prayer. Having an intercessory team that is profoundly committed to their calling as intercessors, highly focused, and specialized. They are prayer warriors who spend hours seeking the Lord and interceding daily.",
